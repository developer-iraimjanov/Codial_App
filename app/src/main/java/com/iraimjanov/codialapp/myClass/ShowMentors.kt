...
import com.iraimjanov.codialapp.adapters.MentorsAdapter
import com.iraimjanov.codialapp.databinding.DialogDeleteBinding
import com.iraimjanov.codialapp.databinding.DialogEditMentorsBinding
    ...
    private fun buildDialogEdit(mentors: Mentors) {
        ...
        bindingEdit.tvSave.setOnClickListener {
            ...
            if (surname.isNotEmpty() && name.isNotEmpty() && patronymic.isNotEmpty()) {
                myDBHelper.updateMentors(Mentors(mentors.id,
                    surname,
                    name,
                    patronymic,
